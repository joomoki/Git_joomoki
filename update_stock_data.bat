...
echo.
echo ==============================================
echo [2/3] D:\joomoki_PJ 의 웹 파일들을 D:\DataStock 에 배포합니다...

xcopy /E /Y /I D:\joomoki_PJ\data D:\DataStock\data > nul
xcopy /E /Y /I D:\joomoki_PJ\js D:\DataStock\js > nul
copy /Y D:\joomoki_PJ\index.html D:\DataStock\index.html
copy /Y D:\joomoki_PJ\discovery.html D:\DataStock\discovery.html
if %errorlevel% neq 0 (
